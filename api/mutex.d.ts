...
interface Mutex {
	...
	/**
	 * mutex constructor
	 * Mutex allow to control code execution order and to prevent conflicts in a multi-thread application.
	...
	/**
	 * Locks the mutex or wait until it has been released. The thread execution is paused until then.
